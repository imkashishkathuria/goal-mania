...
const LaLigaALMemento = () => {
  return (
    <div>
      <Header />
      <div className='py-3 md:py-7'>
        <HomeSections heading="La Liga al momento" subheading="Rimani aggiornato con le novità più importanti dal mondo del calcio: trasferimenti, risultati, curiosità e tanto altro in tempo reale." cards={
...
export default LaLigaALMemento
